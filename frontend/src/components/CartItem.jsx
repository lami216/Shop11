                ...
                >
                        ...
                        <div className='flex flex-col gap-3'>
                                <div className='flex items-start justify-between gap-3'>
                                        <h3 className='text-[clamp(1.05rem,2.4vw,1.25rem)] font-semibold text-black'>{item.name}</h3>
                                        {isDiscounted && (
                                                <span className='rounded-full bg-red-500/20 px-2 py-1 text-xs font-semibold text-red-700'>
                                                        -{discountPercentage}%
                                                </span>
                                        )}
                                </div>
                                ...
                                <div className='flex flex-wrap items-center gap-2 text-sm text-black/60'>
                                        ...
                                        <div className='flex items-center gap-2 text-lg font-semibold text-payzone-gold'>
                                                {isDiscounted && (
                                                        <span className='text-xs font-medium text-black/50 line-through'>
                                ...
                                <div className='flex flex-wrap items-center justify-between gap-3 rounded-xl border border-white/10 bg-payzone-navy/70 px-3 py-2 text-sm text-black/80'>
                                        <div className='flex items-center gap-2'>
                                                ...
                                                <button
                                                        ...
                                                        className='inline-flex h-8 w-8 items-center justify-center rounded-full border border-black/10 bg-black/5 text-black transition hover:border-payzone-gold/80 hover:bg-payzone-navy/80 focus:outline-none focus-visible:ring-2 focus-visible:ring-payzone-gold'
                                                ...
                                                <span
                                                        ...
                                                        className='flex h-8 min-w-[2.5rem] items-center justify-center rounded-lg bg-black/5 text-sm font-semibold text-black'
                                                >
                                        ...
                                        <button
                                                ...
                                                className='inline-flex h-9 items-center justify-center gap-2 rounded-full border border-red-400/40 bg-red-500/15 px-3 text-xs font-semibold text-red-700 transition hover:border-red-400 hover:bg-red-500/25 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-400'

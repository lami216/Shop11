        ...
        <div className='cart-page min-h-screen bg-gradient-to-b from-payzone-navy via-bilady-yellow/15 to-white py-10 text-black sm:py-16' dir='rtl'>
                        <div className='mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8'>
                                <header className='space-y-2 text-center md:text-right'>
                                        ...
                                        {leadText && <p className='text-sm text-black'>{leadText}</p>}
                                </header>
...
const EmptyCartUI = ({ t }) => (
        <motion.div
                className='flex flex-col items-center justify-center space-y-4 rounded-3xl border border-white/10 bg-white/5 px-8 py-16 text-center text-black shadow-xl shadow-black/20 backdrop-blur-md'

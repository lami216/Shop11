                        ...
                        <form onSubmit={handleSubmit} className='space-y-4'>
                                <div>
                                        ...
                                        <input
                                                ...
                                                className='mt-1 block w-full rounded-md border border-payzone-indigo/40 bg-payzone-navy/60 px-3 py-2 text-black placeholder-white/40 focus:border-payzone-gold focus:outline-none focus:ring-2 focus:ring-payzone-indigo'
                                                required
                                        />
                                </div>
                                ...
                                <div className='mt-1 flex items-center'>
                                        ...
                                        <label
                                                htmlFor='images'
                                                className={`inline-flex items-center gap-2 rounded-md border border-payzone-indigo/40 bg-payzone-navy/60 px-3 py-2 text-sm font-medium text-black transition duration-300 focus:outline-none focus:ring-2 focus:ring-payzone-indigo ${
                                        ...
                                        <span className='mr-3 text-sm text-black'>
                                                ...
                                                {galleryItems.map((item) => {
                                                        ...
                                                        return (
                                                                ...
                                                                >
                                                                        ...
                                                                        />
                                                                        <div className='absolute inset-x-0 bottom-0 flex items-center justify-between bg-black/60 px-2 py-1 text-xs text-black'>
                                                                                <button
                                                                                        type='button'
                                ...
                                <button
                                        type='submit'
                                        className='flex w-full items-center justify-center gap-2 rounded-md bg-payzone-gold px-4 py-2 text-sm font-semibold text-black transition duration-300 hover:bg-[#b81f1f] focus:outline-none focus:ring-2 focus:ring-payzone-indigo/60 disabled:opacity-50'

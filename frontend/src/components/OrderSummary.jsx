...
const OrderSummary = () => {
        ...
        return (
                ...
                >
                        ...
                        <div className='space-y-3 rounded-2xl border border-white/12 bg-payzone-navy/70 p-5 text-[clamp(0.95rem,2.4vw,1rem)] text-black/70 shadow-inner'>
                                ...
                                {hasCouponSavings && (
                                        <div className='flex items-center justify-between border-t border-white/12 pt-3 text-sm text-emerald-700'>
                        ...
                        <motion.button
                                type='button'
                                className='w-full rounded-full bg-payzone-gold px-6 py-3 text-sm font-semibold text-black transition-colors duration-300 hover:bg-[#b81f1f] focus:outline-none focus-visible:ring-2 focus-visible:ring-payzone-gold focus-visible:ring-offset-2 focus-visible:ring-offset-payzone-navy disabled:cursor-not-allowed disabled:opacity-60 md:w-1/2 md:self-end'
